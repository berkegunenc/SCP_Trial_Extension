CLASS zbgcl_ce_rap_agency DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES t_agency_range TYPE RANGE OF zrapz_travel_agency_es5-agencyid.
    TYPES t_business_data TYPE TABLE OF zrapz_travel_agency_es5.
...
CLASS zbgcl_ce_rap_agency IMPLEMENTATION.
...
**********************************************************************
  METHOD get_agencies.
    ...
    service_consumption_name = to_upper( 'ZBG_SC_RAP_AGENCY' ).
